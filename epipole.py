...
def epipole(u, v, smin, thresh, num_iterations=1000):
    ...
    output would be best_ep and inliers, which have shapes, respectively (3,) and (n,) 
    """
    ...
    try:
        ...
        for i in range(num_iterations):
            ...
            sample_indices = permuted_indices[:sample_size] #indices for thresholded arrays found above
            test_indices = permuted_indices[sample_size:] #indices for thresholded arrays found above
